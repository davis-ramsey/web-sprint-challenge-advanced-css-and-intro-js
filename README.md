...
Accessibility makes your website usable by people who for example may be blind or colorblind and using a screen reader.

2. Talk about 3 different things you can do to ensure your website is accessible. 

Add alt tags to images, use colors that contrast well, and use semantic html

3. How would you explain the concept of a variable to someone new to programming?

a variable stores some data for use later in a program.

4. What is the purpose of using functions in code?

functions perform some tasks on some data and return the result for use later in the program.
